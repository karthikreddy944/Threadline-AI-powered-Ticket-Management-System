...
import { LayoutGrid, ListTodo, BarChart3, Bell, Settings, Users, Menu, GitBranch } from "lucide-react";
...
export default function AdminLayout() {
  ...
  const navItems = baseNavItems.map((item) =>
    item.to === "/admin/notifications" ? { ...item, count: unreadCount || undefined } : item
  );
